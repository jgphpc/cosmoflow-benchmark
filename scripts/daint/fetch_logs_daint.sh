...
echo "$1 is the experiment type (weak_scaling, data_benchmark, etc.)"
echo "$2 is the timestamp_hostname label"

mkdir -p results/$1/$2
scp -r "daint101:/scratch/snx3000/lukasd/mlperf/cosmoflow-benchmark/results/$1/$2" results/$1/
...
set -x
scp -r "daint101:/scratch/snx3000/lukasd/mlperf/cosmoflow-benchmark/logs/{${logfiles_list}}" results/$1/$2/logs/
set +x
